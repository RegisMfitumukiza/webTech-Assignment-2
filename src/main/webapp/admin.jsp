...
<form action='admin' enctype="multipart/form-data" method="post">
  <fieldset>
    <label for="first-name">Enter Your First Name: <input id="first-name" name="firstName" type="text" required placeholder="Enter your First Name" /></label>
    <label for="last-name">Enter Your Last Name: <input id="last-name" name="lastName" type="text" required placeholder="Enter your Last Name" /></label>
  ...
  <fieldset>
    ...
    <label for="male-gender"><input id="male-gender" type="radio" name="gender" class="inline" /> Male</label>
    <label for="female-gender"><input id="female-gender" type="radio" name="gender" class="inline" /> Female</label>
    <label for="other-gender"><input id="other-gender" type="radio" name="gender" class="inline" /> Other</label>
  </fieldset>
  <fieldset>
    <label for="profile-picture">Upload a profile picture: <input id="profile-picture" type="file" name="profile" accept="image/jpeg, image/png" required /></label>
